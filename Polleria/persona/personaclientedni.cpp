...
#include "ui_personaclientedni.h"

PersonaClienteDNI::PersonaClienteDNI(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PersonaClienteDNI)
{
    ui->setupUi(this);
...
PersonaClienteDNI::~PersonaClienteDNI()
{
    qDebug() << "delete cliente dni" << endl;
    delete ui;
}
QString PersonaClienteDNI::get_ID()
{
    return id;
}
QString PersonaClienteDNI::get_DNI()
{
    return ui->lineEdit_dni->text();
}
QString PersonaClienteDNI::get_nombre()
{
    return ui->lineEdit_nombre->text();
}
QString PersonaClienteDNI::get_direccion()
{
    return ui->lineEdit_direccion->text();
}
void PersonaClienteDNI::set_widget_previous(QWidget *widget_previous)
{
    this->widget_previous = widget_previous;
}
void PersonaClienteDNI::set_captcha()
{
    consulta_dni.set_data(ui->label_captcha, ui->lineEdit_dni
        , ui->lineEdit_codigo_captcha, ui->lineEdit_nombre);
}
bool PersonaClienteDNI::select(const QString& id)
{
    this->id = id;
    QString str_query;
    QSqlQuery query;
...
bool PersonaClienteDNI::guardar()
{
    QString str_query;
...
void PersonaClienteDNI::on_pushButton_guardar_clicked()
{
...
void PersonaClienteDNI::on_pushButton_eliminar_clicked()
{
    if(id.compare("") == 0) {
...
void PersonaClienteDNI::on_pushButton_salir_clicked()
{
...
void PersonaClienteDNI::showEvent(QShowEvent *event)
{
    event->accept();

    afterShow = true;
}
void PersonaClienteDNI::closeEvent(QCloseEvent *event)
{
    event->accept();
    emit closing();
}

bool PersonaClienteDNI::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
