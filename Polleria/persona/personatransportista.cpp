...
#include "ui_personatransportista.h"

PersonaTransportista::PersonaTransportista(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PersonaTransportista)
{
    ui->setupUi(this);
...
PersonaTransportista::~PersonaTransportista()
{
    qDebug()<<"delete transportista op"<<endl;
    delete ui;
}
QString PersonaTransportista::get_ID()
{
    return id;
}
QString PersonaTransportista::get_ruc()
{
    return ui->lineEdit_ruc->text();
}
QString PersonaTransportista::get_razon_social()
{
    return ui->lineEdit_razon_social->text();
}
QString PersonaTransportista::get_direccion()
{
    return ui->lineEdit_direccion->text();
}
void PersonaTransportista::set_widget_previous(QWidget *widget_previous)
{
    this->widget_previous = widget_previous;
}
void PersonaTransportista::set_captcha()
{
...
bool PersonaTransportista::select(const QString& id)
{
    this->id = id;
    QString str_query;
    QSqlQuery query;
...
void PersonaTransportista::set_establecimiento(QString codigo, QString tipo, QString direccion, QString actividad)
{
...
bool PersonaTransportista::guardar()
{
    QString str_query;
    QSqlQuery query;
...
bool PersonaTransportista::remove()
{
    QString str_query;
...
void PersonaTransportista::on_pushButton_guardar_clicked()
{
...
void PersonaTransportista::on_pushButton_eliminar_clicked()
{
    if(id.compare("") == 0) {
...
void PersonaTransportista::on_pushButton_salir_clicked()
{
...
void PersonaTransportista::showEvent(QShowEvent *event)
{
    event->accept();
...
void PersonaTransportista::closeEvent(QCloseEvent *event)
{
    event->accept();
    emit closing();
}

bool PersonaTransportista::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
