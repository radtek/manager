...
#define VISA "Visa"
#define MASTER_CARD "Master Card"
//TYPEDEFS
...
namespace items{
    enum items {
        AMAZONAS = 97, ANCASH = 98, APURIMAC = 99, AREQUIPA = 100
        , AYACUCHO = 101, BANCO = 9, B_COMPRA = 64, B_CONSIGNACION = 68
        ...
        , COSTO_MINIMO_TRASLADO = 60, COTIZACION = 89, CUZCO = 104, DECLARACION = 30
        ...
        , FAX = 18, FECHA_INICIO_TRASLADO = 74, FLETE = 81, FLETE_VALOR = 49
        ...
        , SERIE = 31, SERIE_FACTURA = 56, TACNA = 119, TELEFONO = 17
        ...
        , VENDEDOR_RPC = 24, VENDEDOR_RPM = 25
    };
}
