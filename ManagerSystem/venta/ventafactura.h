#ifndef VENTAFACTURA_H
#define VENTAFACTURA_H

#include "facturacion_global.h"
#include "venta/venta_headers.h"

#include "compra/comprachartcosto.h"

namespace Ui {
class VentaFactura;
}

class FACTURACIONSHARED_EXPORT VentaFactura : public QWidget
{
    Q_OBJECT
