#include "productounidadbuscar.h"
#include "ui_productounidadbuscar.h"

ProductoUnidadBuscar::ProductoUnidadBuscar(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ProductoUnidadBuscar)
{
    ui->setupUi(this);
...
ProductoUnidadBuscar::~ProductoUnidadBuscar()
{
    qDebug() << "delete unidad buscar" << endl;
    delete ui;
}
QString ProductoUnidadBuscar::getID()
{
    return id;
}
QString ProductoUnidadBuscar::getUnidad()
{
    return unidad;
}
void ProductoUnidadBuscar::set_widget_previous(QWidget *widget_previous)
{
    this->widget_previous = widget_previous;
}
void ProductoUnidadBuscar::on_verticalScrollBar_actionTriggered(int value)
{
    QScrollBar* bar = ui->tableWidget->verticalScrollBar();
...
void ProductoUnidadBuscar::on_unidad_closing()
{
    ProductoUnidad* widget_unidad = (ProductoUnidad*)QObject::sender();
    ...
    case MODIFICAR:{
        ...
        ui->tableWidget->item(row, 1)->setText(unidad);
...
void ProductoUnidadBuscar::set_buscar()
{
...
void ProductoUnidadBuscar::on_lineEdit_unidad_buscar_textChanged(const QString& arg)
{
    pos = 0;
...
void ProductoUnidadBuscar::on_lineEdit_unidad_buscar_returnPressed()
{
...
void ProductoUnidadBuscar::on_pushButton_nuevo_clicked()
{
    //int ret = QMessageBox::warning(this, "Advertencia", "¿Desea agregar un UNIDAD?", "Si", "No");
    //switch (ret) {
    //case 0: {
        ProductoUnidad* w = new ProductoUnidad;
...
void ProductoUnidadBuscar::on_pushButton_ok_clicked()
{
...
void ProductoUnidadBuscar::on_pushButton_salir_clicked()
{
...
void ProductoUnidadBuscar::on_pushButton_editar_clicked()
{
    QTableWidgetItem* item = ui->tableWidget->currentItem();

    editarItem(item);
}
void ProductoUnidadBuscar::on_tableWidget_itemDoubleClicked(QTableWidgetItem *item)
{
    if(widget_previous){
...
void ProductoUnidadBuscar::showEvent(QShowEvent *se)
{
    se->accept();
...
void ProductoUnidadBuscar::closeEvent(QCloseEvent * ce)
{
    ce->accept();
    emit closing();
}
bool ProductoUnidadBuscar::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if (obj == w_temp) {
...
void ProductoUnidadBuscar::editarItem(QTableWidgetItem *item)
{
    if(!item){
