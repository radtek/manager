#include "productotipo.h"
#include "ui_productotipo.h"

ProductoTipo::ProductoTipo(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ProductoTipo)
{
    ui->setupUi(this);
    ...
    //ui->lineEdit_ProductoTipo->setValidator(new QRegExpValidator(regExp_in));
...
{
    qDebug()<<"delete ProductoTipo"<<endl;
    delete ui;
}
QString ProductoTipo::getID() {
    return id;
}
QString ProductoTipo::getTipo() {
    return ui->lineEdit_tipo->text();
}
void ProductoTipo::set_widget_previous(QWidget* widget_previous)
{
    this->widget_previous = widget_previous;
}

void ProductoTipo::set_data(QString id, QString tipo)
{
    ui->lineEdit_tipo->setText(tipo);
    this->id = id;
}

bool ProductoTipo::guardar()
{
    QSqlQuery query;
...
void ProductoTipo::on_pushButton_guardar_clicked()
{
...
void ProductoTipo::on_pushButton_eliminar_clicked()
{
    if(id.compare("") == 0) {
...
void ProductoTipo::on_pushButton_salir_clicked()
{
...
void ProductoTipo::showEvent(QShowEvent *se)
{
    se->accept();

    afterShow = true;
}
void ProductoTipo::closeEvent(QCloseEvent *ce)
{
    ce->accept();
    emit closing();
}

bool ProductoTipo::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
