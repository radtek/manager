...
void PreviewTicket::set_cabecera(QString numero, QString fecha, QString nombre)
{
    this->numero = numero;
    this->fecha = fecha;
    this->nombre = nombre;
...
void PreviewTicket::ver_documento()
{
    ...
    text += nombre;
    text += "<br>" + SYSTEM->centerText(QString("Fecha: " + QDate::currentDate().toString("dd/MM/yyyy")));
    text += "<br>" + SYSTEM->centerText(QString("Hora: " + QDateTime::currentDateTime().toString("hh:mm:ss")));
    text += "<br>" + SYSTEM->centerText(QString("========================================"));
