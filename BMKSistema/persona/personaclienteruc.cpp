...
#include "ui_personaclienteruc.h"

PersonaClienteRUC::PersonaClienteRUC(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PersonaClienteRUC)
{
    ui->setupUi(this);
...
PersonaClienteRUC::~PersonaClienteRUC()
{
    qDebug()<<"delete cliente ruc"<<endl;
    delete ui;
}
QString PersonaClienteRUC::get_ID()
{
    return id;
}
QString PersonaClienteRUC::get_ruc()
{
    return ui->lineEdit_ruc->text();
}
QString PersonaClienteRUC::get_razon_social()
{
    return ui->lineEdit_razon_social->text();
}
QString PersonaClienteRUC::get_direccion()
{
    return ui->lineEdit_direccion->text();
}
void PersonaClienteRUC::set_widget_previous(QWidget *widget_previous)
{
    this->widget_previous = widget_previous;
}

void PersonaClienteRUC::set_captcha()
{
...
bool PersonaClienteRUC::select(const QString& id)
{
    this->id = id;
    QString str_query;
    QSqlQuery query;
...
void PersonaClienteRUC::set_establecimiento(QString codigo, QString tipo, QString direccion, QString actividad)
{
...
bool PersonaClienteRUC::guardar()
{
    QString str_query;
    QSqlQuery query;
...
void PersonaClienteRUC::on_pushButton_guardar_clicked()
{
...
void PersonaClienteRUC::on_pushButton_eliminar_clicked()
{
    if(id.compare("") == 0) {
...
void PersonaClienteRUC::on_pushButton_salir_clicked()
{
...
void PersonaClienteRUC::showEvent(QShowEvent *event)
{
    event->accept();

    afterShow = true;
}
void PersonaClienteRUC::closeEvent(QCloseEvent *event)
{
    event->accept();
    emit closing();
}

bool PersonaClienteRUC::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
