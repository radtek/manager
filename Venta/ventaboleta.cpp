...
void VentaBoleta::on_pushButton_transformar_clicked()
{
    ...
    case 0:{
        ...
        if(id.compare("") == 0){
            ...
            w->set_data(venta_items::BOLETA, id, persona_id, tipo_persona_id
            , fecha_emision, ""
            , serie, numero
            , codigo, nombre
            , direccion, productos);
...
void VentaBoleta::on_dateTimeEdit_emision_dateChanged(const QDate &date)
{
