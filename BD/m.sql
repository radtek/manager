...
-- -----------------------------------------------------
-- Table `managersystem`.`delimitador`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `managersystem`.`delimitador` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `managersystem`.`delimitador` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `delimitador_final_consulta` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
