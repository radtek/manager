 ...
 */
class __declspec(dllexport) TESS_API TessResultRenderer {
  public:
 ...
 */
class __declspec(dllexport) TESS_API TessTextRenderer : public TessResultRenderer {
 public:
 ...
 */
class __declspec(dllexport) TESS_API TessHOcrRenderer : public TessResultRenderer {
 public:
 ...
 */
class __declspec(dllexport) TESS_API TessTsvRenderer : public TessResultRenderer {
 public:
 ...
 */
class __declspec(dllexport) TESS_API TessPDFRenderer : public TessResultRenderer {
 public:
 ...
 * Renders tesseract output into a plain UTF-8 text string
 */
class __declspec(dllexport) TESS_API TessUnlvRenderer : public TessResultRenderer {
 public:
 ...
 * Renders tesseract output into a plain UTF-8 text string
 */
class __declspec(dllexport) TESS_API TessBoxTextRenderer : public TessResultRenderer {
 public:
 ...
 */
class __declspec(dllexport) TESS_API TessOsdRenderer : public TessResultRenderer {
 public:
