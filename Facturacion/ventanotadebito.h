#ifndef VENTANOTADEBITO_H
#define VENTANOTADEBITO_H

#include "facturacion_global.h"
#include "venta_headers.h"

namespace Ui {
class VentaNotaDebito;
}

class FACTURACIONSHARED_EXPORT VentaNotaDebito : public QWidget
{
    Q_OBJECT

public:
    explicit VentaNotaDebito(QWidget *parent = 0);
    ~VentaNotaDebito();
    ...
    enum{INDEX_ID = 0, INDEX_CANTIDAD, INDEX_UNIDAD, INDEX_DESCRIPCION, INDEX_P_UNIT
          , INDEX_P_TOTAL, INDEX_AUMENTO_P_TOTAL};
