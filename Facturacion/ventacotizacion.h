#ifndef VENTACOTIZACION_H
#define VENTACOTIZACION_H

#include "facturacion_global.h"
#include "venta_headers.h"

namespace Ui {
class VentaCotizacion;
}

class FACTURACIONSHARED_EXPORT VentaCotizacion : public QWidget
{
    Q_OBJECT

public:
    explicit VentaCotizacion(QWidget *parent = 0);
    ~VentaCotizacion();
