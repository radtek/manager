...
void VentaAmarres::set_documento(QString id, int tipo)
{
    this->id = id;
    this->tipo = tipo;
...
void VentaAmarres::on_compra_closing()
{
...
void VentaAmarres::on_pushButton_editar_clicked()
{
    QTableWidgetItem* item = ui->tableWidget->currentItem();
    editarItem(item);
}
void VentaAmarres::editarItem(QTableWidgetItem *item)
{
...
void VentaAmarres::on_tableWidget_itemDoubleClicked(QTableWidgetItem *item)
{
    editarItem(item);
}
void VentaAmarres::on_pushButton_salir_clicked()
{
    if(widget_previous){
...
void VentaAmarres::showEvent(QShowEvent *se)
{
    se->accept();

    afterShow = true;
}
void VentaAmarres::closeEvent(QCloseEvent *ce)
{
    ce->accept();
    emit closing();
}
bool VentaAmarres::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
