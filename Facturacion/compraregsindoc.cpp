...
#include "ui_compraregsindoc.h"

CompraRegSinDoc::CompraRegSinDoc(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CompraRegSinDoc)
{
    ui->setupUi(this);
...
CompraRegSinDoc::~CompraRegSinDoc()
{
    qDebug()<<"delete compra reg sin doc"<<endl;
    delete ui;
}
QString CompraRegSinDoc::getID()
{
    return id;
}
QString CompraRegSinDoc::getFechaEmision()
{
    return ui->dateTimeEdit_emision->date().toString("dd-MM-yyyy");
}
void CompraRegSinDoc::set_widget_previous(QWidget *w)
{
    this->widget_previous = w;
}

bool CompraRegSinDoc::select(QString id, QString fecha_emision)
{
    this->id = id;
...
void CompraRegSinDoc::set_producto(QString producto_id
...
void CompraRegSinDoc::set_time()
{
    ui->dateTimeEdit_sistema->setDateTime(QDateTime::currentDateTime());
}

void CompraRegSinDoc::on_producto_closing()
{
...
void CompraRegSinDoc::on_pushButton_ing_prod_clicked()
{
    /*
    if(persona_id == ""){
...
void CompraRegSinDoc::on_tableWidget_itemChanged(QTableWidgetItem *item)
{
    disconnect(ui->tableWidget, SIGNAL(itemChanged(QTableWidgetItem*))
               , this, SLOT(on_tableWidget_itemChanged(QTableWidgetItem*)));
...
void CompraRegSinDoc::on_pushButton_guardar_clicked()
{
...
void CompraRegSinDoc::on_pushButton_salir_clicked()
{
...
void CompraRegSinDoc::on_dateTimeEdit_emision_dateChanged(const QDate &date)
{

}

void CompraRegSinDoc::showEvent(QShowEvent *se)
{
    se->accept();

    afterShow = true;
}
void CompraRegSinDoc::hideEvent(QHideEvent *he)
{
    emit hiding();
    he->accept();
}
void CompraRegSinDoc::closeEvent(QCloseEvent *ce)
{
    emit closing();
    ce->accept();
}
bool CompraRegSinDoc::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
...
void CompraRegSinDoc::on_pushButton_borrar_clicked()
{
...
void CompraRegSinDoc::on_pushButton_up_clicked()
{
    QTableWidgetItem* item= ui->tableWidget->currentItem();
    if(item){
        int column = item->column();
