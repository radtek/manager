...
#include "ui_proveedorop.h"

ProveedorOp::ProveedorOp(QWidget *parent) :
   QWidget(parent),
    ui(new Ui::ProveedorOp)
{
    ui->setupUi(this);
...
ProveedorOp::~ProveedorOp()
{
    qDebug()<<"delete proveedor op"<<endl;
    delete ui;
}
QString ProveedorOp::get_ID()
{
    return id;
}
QString ProveedorOp::get_ruc()
{
    return ui->lineEdit_ruc->text();
}
QString ProveedorOp::get_razon_social()
{
    return ui->lineEdit_razon_social->text();
}
QString ProveedorOp::get_direccion()
{
    return ui->lineEdit_direccion->text();
}
void ProveedorOp::set_widget_previous(QWidget *widget_previous)
{
    this->widget_previous = widget_previous;
}

void ProveedorOp::set_captcha()
{
...
bool ProveedorOp::select(const QString& id)
{
    this->id = id;
    QString str_query;
    QSqlQuery query;
...
void ProveedorOp::set_establecimiento(QString codigo, QString tipo, QString direccion, QString actividad)
{
...
void ProveedorOp::on_pushButton_guardar_clicked()
{
...
void ProveedorOp::on_pushButton_eliminar_clicked()
{
    if(id.compare("") == 0) {
...
void ProveedorOp::on_pushButton_salir_clicked()
{
...
void ProveedorOp::showEvent(QShowEvent *event)
{
    event->accept();

    afterShow = true;
}
void ProveedorOp::closeEvent(QCloseEvent *event)
{
    event->accept();
    emit closing();    
}
bool ProveedorOp::eventFilter(QObject *obj, QEvent *e)
{
    QWidget* w_temp;
    w_temp = this;
    if(obj == w_temp){
