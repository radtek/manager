...
void TipoBuscar::on_verticalScrollBar_actionTriggered(int value)
{
    QScrollBar* bar = ui->tableWidget->verticalScrollBar();
...
void TipoBuscar::on_pushButton_editar_clicked()
{
    QTableWidgetItem* item = ui->tableWidget->currentItem();
...
void TipoBuscar::editarItem(QTableWidgetItem *item)
{
    if(!item){
