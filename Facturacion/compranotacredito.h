#ifndef COMPRANOTACREDITO_H
#define COMPRANOTACREDITO_H

#include "facturacion_global.h"
#include "compra_headers.h"

namespace Ui {
class CompraNotaCredito;
}

class FACTURACIONSHARED_EXPORT CompraNotaCredito : public QWidget
{
    Q_OBJECT

public:
    explicit CompraNotaCredito(QWidget *parent = 0);
    ~CompraNotaCredito();
    ...
    enum{INDEX_ID = 0, INDEX_CANTIDAD, INDEX_UNIDAD, INDEX_DESCRIPCION, INDEX_P_UNIT, INDEX_P_TOTAL
          , INDEX_DESC_CANT, INDEX_DESC_P_TOTAL};
