...
QString CompraOrden::getID()
{
    return id;
}
QString CompraOrden::getPersonaID()
{
    return persona_id;
}
QString CompraOrden::getFechaEmision()
{
    return ui->dateTimeEdit_emision->date().toString("dd-MM-yyyy");
}
QString CompraOrden::getSerie()
{
    return ui->lineEdit_serie->text();
}
QString CompraOrden::getNumero()
{
    return ui->lineEdit_numero->text();
}
QString CompraOrden::getCodigo()
{
    return ui->lineEdit_cod->text();
}
QString CompraOrden::getNombre()
{
